...
exports.ConversationModule = ConversationModule = __decorate([
    (0, common_1.Module)({
        ...
        imports: [typeorm_1.TypeOrmModule.forFeature([conversation_entity_1.Conversation, conversationMessages_entity_1.ConversationMessages]), user_module_1.UserModule, cloudinary_module_1.CloudinaryModule, notifications_module_1.NotificationsModule]
    })
], ConversationModule);
